          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="text-center lg:text-left lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-7xl md:text-6xl font-bold leading-tight animate-fade-in-up">
                  <span className="bg-gradient-to-r from-green-500 to-purple-800 bg-clip-text text-transparent animate-fade-in-up delay-200">
                    Get In
                  </span>
                  <span className="text-gray-800 animate-fade-in-up delay-300">Touch</span>
                  <span className="text-green-500 animate-fade-in-up delay-400">.</span>
                </h1>
              </div>
              ...
              <div className="space-y-6">
                <p className="text-gray-700 text-lg lg:text-xl xl:text-2xl leading-relaxed max-w-2xl animate-fade-in-up delay-500">
                  ...
                  <span className="text-green-500 font-semibold">amazing digital experiences</span> that your users will
                  love.
                </p>
              ...
              <div className="space-y-4 animate-fade-in-up delay-700">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-800 font-semibold">mayurnakum07@gmail.com</p>
                  </div>
                </Link>
                ...
                <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-800 font-semibold">Available for new projects</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center w-72 md:w-80 lg:w-96 h-72 md:h-80 lg:h-96 animate-fade-in-up delay-300">
              ...
              <div className="relative w-full h-full rounded-full border-4 border-purple-300 shadow-xl overflow-hidden">
                ...
                {/* Floating Elements */}
                <div className="absolute -top-2 -right-2 w-8 h-8 bg-green-500 rounded-full animate-bounce delay-1000"></div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-gray-50 rounded-2xl p-8 lg:p-12 border border-purple-100">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">{`Let's`} Start Your Project</h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={LINKS.Email}
                className="group px-8 py-4 bg-green-500 text-white rounded-xl hover:bg-purple-700 font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2"
              >
              ...
              <Link
                ...
                className="group px-8 py-4 bg-transparent border-2 border-green-500 text-green-500 rounded-xl hover:bg-green-500 hover:text-white font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
              >
                Download Resume
              </Link>
            </div>
