  ...
  return (
    <section className="pb-32">
        ...
        {projectData.map((item, index) => (
          ...
          >
            ...
            <div className="p-6 lg:p-8">
              ...
              {/* Project Description */}
              <p className="text-gray-600 text-sm lg:text-base leading-relaxed mb-6">{item.description}</p>
      ...
      <div className="mt-16 text-center">
        <div className="bg-transparent border border-sky-100 rounded-2xl p-8 lg:p-12">
          <h3 className="text-2xl lg:text-3xl font-bold text-sky-100 mb-4">Ready to Start Your Project?</h3>
          <p className="text-sky-100 text-lg mb-6 max-w-2xl mx-auto">
            {` Let's`} work together to bring your ideas to life. {`I'm`} always excited to take on new challenges and
            create amazing digital experiences.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href={LINKS.Contact}
              className="px-8 py-3 bg-emerald-500 text-sky-100 rounded-lg hover:bg-emerald-600 font-semibold transition-colors duration-200 flex items-center justify-center gap-2"
            >
              <ExternalLink size={20} />
              Start a Project
            </Link>
            <Link target="_blank" rel="noopener noreferrer" href={LINKS.Github}>
              <button className="px-8 py-3 bg-transparent border-2 border-emerald-500 text-emerald-500 rounded-lg hover:bg-emerald-500 hover:text-sky-100 font-semibold transition-all duration-200">
                View More Work
              </button>
            </Link>
          </div>
