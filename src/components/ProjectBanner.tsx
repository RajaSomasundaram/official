      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-28">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explore some of my recent work that showcases my expertise in modern web and mobile development
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-semibold text-green-500 bg-purple-50 px-2 py-1 rounded-full">
                    {project.status}
                  </span>
                  <span className="text-xs text-gray-500">Project {String(index + 1).padStart(2, "0")}</span>
                </div>

                <h3 className="text-xl font-bold text-gray-800 mb-3 group-hover:text-green-500 transition-colors duration-300">
                  {project.title}
        ...
        <div className="text-center">
          <div className="bg-white rounded-2xl p-8 lg:p-12 shadow-lg border border-gray-100">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-4">Want to See More?</h3>
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              Discover my complete portfolio of projects, from web applications to mobile apps, each crafted with
              attention to detail and modern development practices.
            </p>
